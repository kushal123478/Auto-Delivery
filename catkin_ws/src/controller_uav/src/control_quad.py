...
class HectorBot:
    ...
    def steering_angle(self, goal_pose):
        """See video: https://www.youtube.com/watch?v=Qh15Nol5htM."""
	print("The required angle")
        print(atan((goal_pose.pose.pose.position.y - self.odom.pose.pose.position.y)/ (goal_pose.pose.pose.position.x - self.odom.pose.pose.position.x)))
    ...
    def move2goal(self):
        ...
        goal_pose.pose.pose.position.z = input("Set your z goal: ")
        ...
        #while self.euclidean_distance_x(goal_pose) >= distance_tolerance or self.euclidean_distance_z(goal_pose) >= distance_tolerance or self.euclidean_distance_z(goal_pose) >= distance_tolerance :
        while True:
